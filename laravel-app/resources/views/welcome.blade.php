        ...
        <div class="sidebar">
            <div class="sidebar-text d-flex flex-column h-100 justify-content-center text-center">
                ...
                <div class="d-flex justify-content-center mt-auto mb-3">
                    ...
                    <a class="mx-2" target="_blank" href="#"><i class="fab fa-facebook-f"></i></a>
                    ...
                    <a class="mx-2" target="_blank" href="#"><i class="fab fa-youtube"></i></a>
                </div>
                        ...
                        <div class="row portfolio-container">
                            <div class="col-md-6 mb-4 portfolio-item first">
                                <div class="position-relative overflow-hidden mb-2">
                                    <img class="img-fluid w-100" src="{{ asset('assets/images/portfolio-1.jpg') }}" alt="">
                                    <div class="portfolio-btn d-flex align-items-center justify-content-center">
                                        <a href="{{ asset('assets/images/portfolio-1.jpg') }}" data-lightbox="portfolio">
                            ...
                            <div class="col-md-6 mb-4 portfolio-item second">
                                <div class="position-relative overflow-hidden mb-2">
                                    <img class="img-fluid w-100" src="{{ asset('assets/images/portfolio-2.jpg') }}" alt="">
                                    <div class="portfolio-btn d-flex align-items-center justify-content-center">
                                        <a href="{{ asset('assets/images/portfolio-2.jpg') }}" data-lightbox="portfolio">
                                            <i class="fa fa-4x fa-plus text-white"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 mb-4 portfolio-item first">
                                <div class="position-relative overflow-hidden mb-2">
                                    <img class="img-fluid w-100" src="{{ asset('assets/images/portfolio-3.jpg') }}" alt="">
                                    <div class="portfolio-btn d-flex align-items-center justify-content-center">
                                        <a href="{{ asset('assets/images/portfolio-3.jpg') }}" data-lightbox="portfolio">
                                            <i class="fa fa-4x fa-plus text-white"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 mb-4 portfolio-item second">
                                <div class="position-relative overflow-hidden mb-2">
                                    <img class="img-fluid w-100" src="{{ asset('assets/images/portfolio-4.jpg') }}" alt="">
                                    <div class="portfolio-btn d-flex align-items-center justify-content-center">
                                        <a href="{{ asset('assets/images/portfolio-4.jpg') }}" data-lightbox="portfolio">
                                            <i class="fa fa-4x fa-plus text-white"></i>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="col-12">
                        <div class="owl-carousel testimonial-carousel">
                            <div class="text-left">
                                ...
                                <h4 class="text-body mb-4">This guy is very honest, skilled at tech.i have been working with him for more than 7 years and still working with him. His experience is unbelievable.i highly recommend him.</h4>
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid" src="{{ asset('assets/images/testimonial-1.jpg') }}"
                                        style="width: 60px; height: 60px;">
                                    <div class="pl-3">
                                        <h5 class="text-primary m-0">Hasanuzzman Shohag</h5>
                                        <i>Profession</i>
                                    </div>
                                </div>
                            </div>
                            <div class="text-left">
                                <i class="fa fa-3x fa-quote-left text-primary mb-4"></i>
                                <h4 class="text-body mb-4">Dolor eirmod diam stet kasd sed. Aliqu rebum est eos. Rebum
                                    elitr dolore et eos labore, stet justo sed est sed. Diam sed sed dolor stet accusam
                                    amet eirmod eos, labore diam clita</h4>
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid" src="{{ asset('assets/images/testimonial-2.jpg') }}"
                                        style="width: 60px; height: 60px;">
                                    <div class="pl-3">
                            ...
                            <div class="text-left">
                                ...
                                <h4 class="text-body mb-4">Dolor eirmod diam stet kasd sed. Aliqu rebum est eos. Rebum
                                    ...
                                    amet eirmod eos, labore diam clita</h4>
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid" src="{{ asset('assets/images/testimonial-3.jpg') }}"
                                        style="width: 60px; height: 60px;">
                                    <div class="pl-3">
                                        <h5 class="text-primary m-0">Client Name</h5>
                                        <i>Profession</i>
                        ...
                        <div class="contact-form">
                            ...
                            <form name="sentMessage" id="contactForm" novalidate="novalidate">
                                <div class="form-row">
                                    ...
                                    <div class="control-group col-sm-6">
                                        <input type="email" class="form-.blade.php
                                            required="required"
